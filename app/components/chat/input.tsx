...
export default function Input() {
  const styles = {
    container:
      'absolute bottom-12 flex flex-row self-center justify-between bg-slate-200 rounded-md p-4 w-3/4 max-h-full z-100',
    input: 'bg-transparent basis-[97%] min-h-8 content-start',
